...
const signUpSchema = yup.object({
  ...
  password_confirme: yup.string().required('Confirme a senha.').oneOf([yup.ref('password')], 'A confirmação da senha não confere'),
})
       ...
       Crie sua conta
        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            ...
            returnKeyType='send'
            errorMessage={errors.password_confirme?.message}
            />
          )}
        />
